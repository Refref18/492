...
import os
import logging
from mouth_out_load import VideoPoseDataset
import torch.optim.lr_scheduler as lr_scheduler
import csv
import numpy as np
import matplotlib.pyplot as plt
from mouth_out_load import custom_collate_fn
...
graph = Graph(**{"layout": "mmpose_mouth_12", "strategy": "spatial"})
...
torch.save(model.state_dict(), 'stgcn_model_mouth_out.pth')
