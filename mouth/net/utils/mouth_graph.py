...
class Graph():
    ...
    def get_edge(self, layout):
        ...
        #     pass
            ...
            self.num_node = 11
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(3, 4), (3, 10), (5, 10), (8, 9), (0, 2), (1, 6), (6, 8), (4, 5), (5, 6), (5, 9), (0, 1), (9, 10), (1, 2), (0, 4), (2, 7), (1, 5), (6, 7), (4, 10), (5,8), (0, 3), (1, 4), (2, 6), (7, 8)]
            self.edge = self_link + neighbor_link
            self.center = 1
            self.unique_nodes = self.get_unique_nodes(neighbor_link)
        # elif layout=='customer settings'
        #     pass
            ...
            self.num_node = 23
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(6, 18), (3, 4), (18, 20), (12, 13), (21, 22), (4, 15), (0, 2), (5, 16), (8, 9), (0, 5), (14, 22), (8, 18), (1, 6), (17, 18), (17, 21), (2, 8), (13, 14), (11, 20), (16, 22), (18, 19), (6, 17), (4, 5), (5, 6), (12, 21), (3, 15), (14, 15), (0, 1), (9, 10), (1, 2), (0, 4), (9, 19), (2, 7), (1, 5), (10, 11), (17, 20), (19, 20), (10, 20), (6, 7), (15, 16), (13, 22), (6, 16), (15, 22), (7, 18), (20, 21), (4, 16), (3, 14), (0, 3), (11, 12), (2, 9), (1, 7), (8, 19), (17, 22), (11, 21), (10, 19), (7, 8), (13, 21), (16, 17)]
            self.edge = self_link + neighbor_link
            self.center = 1
            self.unique_nodes = self.get_unique_nodes(neighbor_link)
        # elif layout=='customer settings'
